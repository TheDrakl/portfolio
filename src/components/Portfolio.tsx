...
function Portfolio() {
  ...
  return (
    <section className="flex flex-col md:flex-row text-white min-h-[200vh] mt-[10%] px-4 md:px-8 max-w-[2560px] m-auto">
      ...
      <div className="w-full md:w-2/3 space-y-[15vh] md:space-y-[30vh] py-8 md:py-16 font-inter">
